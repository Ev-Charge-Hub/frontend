...
function Filter({closeFilter, setStationData, setDefaultData}) {
    ...
    return (
        <div className="absolute bg-white z-10 h-full w-full px-4 sm:w-4/12 sm:h-5/6 sm:px-4 sm:py-2 sm:mt-4 rounded-lg top-20 left-1/2 -translate-x-1/2 sm:left-auto sm:right-4 sm:translate-x-0">
